...
import { CheckCircle, AlertTriangle, Info, AlertCircle, Volume2, VolumeX, Pause, Play, Key, Eye, EyeOff } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Enter your Perplexity API key to enable grammar checking. Get your key from{" "}
                <a 
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 mb-6">
                    ...
                    <div className="text-center p-2 bg-secondary/10 rounded-lg">
                      <div className="text-sm font-bold text-secondary">
                        {issues.filter(i => i.type === "clarity").length}
                      </div>
                      <div className="text-xs text-muted-foreground">Clarity</div>
                    </div>
                    <div className="text-center p-2 bg-accent/10 rounded-lg">
                      <div className="text-sm font-bold text-accent">
                        {issues.filter(i => i.type === "conciseness").length}
                      </div>
                      <div className="text-xs text-muted-foreground">Concise</div>
                    </div>
                  </div>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Advanced AI analyzes your text for grammar, spelling, style, clarity, and conciseness
              </p>
            </CardContent>
          </Card>
